...
Generates answers from retrieved context using OpenAI's GPT-4o
"""
import os
import sys
...
class GPT4oGenerator:
    """
    GPT-4o powered response generator
    ...
    def __init__(
        ...
        if not api_key:
            raise ValueError(
                ...
                "Set OPENAI_API_KEY in .env file or pass as argument"
            )
        ...
        print(f"✓ GPT-4o Generator initialized")
